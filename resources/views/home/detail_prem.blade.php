  ...
  <section id="product" class="product">
      <div class="product-display">
          <div class="main-image" id="sticky-image">
              <img src="{{ asset('profil/img/Premium/premium.png')}}" id="main-img" class="main-img">
              <div class="thumbnails">
                  <img src="{{ asset('profil/img/Premium/premium.png')}}" alt="Premium Terrarium Substrate Mix Thumbnail" class="thumbnail-img" onclick="changeMainImage(this)">
                  <img src="{{ asset('profil/img/Premium/premium-1.jpg')}}" alt="Another Thumbnail" class="thumbnail-img" onclick="changeMainImage(this)">
                  <img src="{{ asset('profil/img/Premium/premium-2.jpg')}}" alt="Another Thumbnail" class="thumbnail-img" onclick="changeMainImage(this)">
                  <img src="{{ asset('profil/img/Premium/premium-3.jpg')}}" alt="Another Thumbnail" class="thumbnail-img" onclick="changeMainImage(this)">
                  <img src="{{ asset('profil/img/Premium/premium-4.jpg')}}" alt="Another Thumbnail" class="thumbnail-img" onclick="changeMainImage(this)">
                  <!-- <img src="{{ asset('profil/img/Premium/premium-5.jpg')}}" alt="Another Thumbnail" class="thumbnail-img" onclick="changeMainImage(this)"> -->
                  <img src="{{ asset('profil/img/Premium/premium-6.jpg')}}" alt="Another Thumbnail" class="thumbnail-img" onclick="changeMainImage(this)">
              </div>
          </div>
          
          <div class="product-details">
              <p>Terrarium.qu</p>
              <h2>TERRARIUM.QU KIT PREMIUM</h2>
              ...
              <div class="description"><br><br>
                  ...
                  <p>
                        Miniatur hutan dalam wadah kaca variasi premium berkualitas tinggi.
                    </p>
                    <p>
