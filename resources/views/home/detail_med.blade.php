    ...
    <section id="product" class="product">
        <div class="product-display">
            <div class="main-image" id="sticky-image">
                <img id="main-img" src="{{ asset('profil/img/Medium/medium.png') }}" alt="Main Product Image">
                <div class="thumbnails">
                    <img src="{{ asset('profil/img/Medium/medium.png') }}" alt="Premium Terrarium Substrate Mix Thumbnail" onclick="changeMainImage(this)">
                    <img src="{{ asset('profil/img/Medium/medium-1.jpg') }}" alt="Another Thumbnail" onclick="changeMainImage(this)">
                    <img src="{{ asset('profil/img/Medium/medium-2.jpg') }}" alt="Another Thumbnail" onclick="changeMainImage(this)">
            ...
            <div class="product-details">
                ...
                <div class="description"><br><br>
                    ...
                    <p>Dapatkan 1 kit terrarium.qu variasi medium berisikan: </p>
                    <ol>
                        <li>Wadah kaca berbentuk botol ukuran sedang </li>
                        <li>Tanaman hias </li>
                        <li>Moss</li>
                        <li>Pupuk</li>
                        <li>Pasir malang</li>
