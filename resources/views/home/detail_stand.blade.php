    ...
    <section id="product" class="product">
        <div class="product-display">
            <div class="main-image" id="sticky-image">
                <img src="{{ asset('profil/img/Standard/standar.jpg') }}" id="main-img">
                <div class="thumbnails">
                    <img src="{{ asset('profil/img/Standard/standar.jpg') }}" alt="Standard Terrarium Substrate Mix Thumbnail" onclick="changeMainImage(this)">
                    <img src="{{ asset('profil/img/Standard/standar-1.jpg') }}" alt="Another Thumbnail"onclick="changeMainImage(this)">
                    <!-- <img src="{{ asset('profil/img/Standard/standar-2.jpg') }}" alt="Another Thumbnail"onclick="changeMainImage(this)"> -->
                    <img src="{{ asset('profil/img/Standard/standar-3.jpg') }}" alt="Another Thumbnail"onclick="changeMainImage(this)">
                    <img src="{{ asset('profil/img/Standard/standar-4.jpg') }}" alt="Another Thumbnail"onclick="changeMainImage(this)">
                    <!-- <img src="{{ asset('profil/img/Standard/standar-5.jpg') }}" alt="Another Thumbnail"onclick="changeMainImage(this)"> -->
                    <img src="{{ asset('profil/img/Standard/standar-6.jpg') }}" alt="Another Thumbnail"onclick="changeMainImage(this)">
                    <img src="{{ asset('profil/img/Standard/standar-7.jpg') }}" alt="Another Thumbnail"onclick="changeMainImage(this)">
                    <!-- <img src="{{ asset('profil/img/Standard/standar-8.jpg') }}" alt="Another Thumbnail"onclick="changeMainImage(this)"> -->
                    <!-- <img src="{{ asset('profil/img/Standard/standar-9.jpg') }}" alt="Another Thumbnail"onclick="changeMainImage(this)"> -->
                </div>
            </div>
            
            <div class="product-details">
                <p>Terrarium.qu</p>
                <h2>TERRARIUM.QU KIT STANDAR</h2>
                ...
                <div class="description"><br><br>
                    ...
                    <p>
                        Miniatur hutan dalam wadah kaca variasi standar berkualitas tinggi.
                    </p>
                    <p>
                        Produk dijual terpisah dalam 1 kit. Bebas kreasikan dunia terrarium.qu milikmu!
                    </p>
                    <p>Dapatkan 1 kit terrarium.qu variasi standar berisikan: </p>
                    <ol>
                        <li>Wadah kaca berbentuk botol ukuran kecil </li>
                        <li>Tanaman hias </li>
                        <li>Moss</li>
                        <li>Pupuk</li>
                        <li>Pasir malang</li>
